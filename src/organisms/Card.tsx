...
const Card: React.FC<CardProps> = ({ img, routes, title, desciption }) => {
  ...
  return (
    <div 
      className='sm:w-full w-[280px] max-w-md mx-auto my-4 cursor-pointer border border-gray-300 rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transition duration-300 ease-in-out' 
      onClick={handleClick}
    >
